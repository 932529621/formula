<template>
  <v-app>
    <racenav></racenav>
    <lastestdetail v-if="hasinfo"></lastestdetail>
    <div class="latestempty"></div>
    <lastestdetailnext v-if="hasinfo"></lastestdetailnext>
    <partner></partner>
    <bottom></bottom>
...
import lastestdetail from "../../../components/front/Latest/latestdetailmain.vue";
import racenav from "../../../components/front/homes/nav.vue";
import lastestdetailAlsolike from "../../../components/front/Latest/latestdetaileAlsolike.vue";
import lastestdetailnext from "../../../components/front/Latest/latestdetailnext.vue";
...
export default {
  ...
  methods: {
    ...
    async hasfavo() {
      ...
      res.data.NewsfavoArr.forEach((item, index) => {
        item.news_id === this.$route.query.news_id
          ? (this.isFavo = true)
          : (this.isFavo = false);
      });
    },
